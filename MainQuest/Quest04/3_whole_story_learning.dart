...
class WholeStoryScreen extends StatefulWidget {
  @override
  _WholeStoryScreenState createState() => _WholeStoryScreenState();
}

class _WholeStoryScreenState extends State<WholeStoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("My ex-boyfriend's wedding")),
